...
- `CLAUDE.md` dosyasındaki `Summer Animated Page - Yaz Dönemi Animasyon Sayfası`, `Summer Animated Page - Yaz Dönemi Animasyon Sayfası — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
